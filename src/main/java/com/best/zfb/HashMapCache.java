...
public class HashMapCache<K, V> implements Cache<K, V> {
     ...
     */
    public HashMapCache(String name, long maxSize, long maxLifetime) {
        this.name = name;
    ...
    public synchronized V put(K key, V value) {
        ...
        HashMapCache.CacheObject<V> cacheObject = new HashMapCache.CacheObject<V>(value, objectSize);
    ...
    public synchronized V get(Object key) {
        ...
        HashMapCache.CacheObject<V> cacheObject = map.get(key);
        if (cacheObject == null) {
    ...
    public Collection<V> values() {
        ...
        // maximum defined age.
        deleteExpiredEntries();
        return new HashMapCache.CacheObjectCollection(map.values());
    }
    ...
    private final class CacheObjectCollection<V> implements Collection<V> {
        ...
        public Iterator<V> iterator() {
            return new Iterator<V>() {
                ...
                public V next() {
                    if (it.hasNext()) {
                        HashMapCache.CacheObject<V> object = it.next();
                        if (object == null) {
                            return null;
                        }
                        else {
    ...
    private int calculateSize(Object object) {
        ...
        // Default behavior -- serialize the object to determine its size.
            ...
            try {
                ...
                HashMapCache.NullOutputStream out = new HashMapCache.NullOutputStream();
